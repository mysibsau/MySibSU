    ...
    return(
        <View style={[styles.container, {backgroundColor: theme.primaryBackground}]}>
            ...
            <ScrollView contentContainerStyle={{paddingBottom: 120}}>
                ...
                <Text style={{ fontWeight: 'bold', fontSize: 20, color: '#006AB3', marginLeft: w * 0.05}}>{locale['name']}</Text>
                ...
                <Text style={{ fontWeight: 'bold', fontSize: 20, color: '#006AB3', marginLeft: w * 0.05, marginTop: 20}}>{locale['place']}</Text>
                <View style={{width: w * 0.9, borderRadius: 15, backgroundColor: theme.blockColor, elevation: 6, alignSelf: 'center', padding: 10, marginTop: 10}}>
                ...
                <TouchableOpacity onPress={() => props.navigation.navigate('Concerts', {id: item.id})} style={{width: w * 0.9, padding: 20, backgroundColor: '#006AB3', borderRadius: 15, alignSelf: 'center', marginTop: 30, elevation: 5}}>
                    <Text style={{  fontWeight: 'bold', fontSize: 18, alignSelf: 'center', color: 'white'}}>{locale['book_a_ticket']}</Text>
                </TouchableOpacity>
            </ScrollView>
        </View>
    )
