    ...
    if (number == 1){
        return(
            ...
            <ScrollView>
                ...
                <Text style={{  fontSize: 22, marginTop: w * 0.2 + 20, marginLeft: 20, color: theme.blueColor,}}>{locale['director']}</Text>
                <View style={[styles.box, styles.centerContent, styles.shadow2, {backgroundColor: theme.blockColor}]}>
                    <Text style={{ fontSize: 20, color: theme.blueColor}}>{data.name}</Text>
                </View>
                <View style={[styles.box, styles.centerContent, styles.shadow2, {flexDirection: 'row', backgroundColor: theme.blockColor}]}>
                    ...
                    <Text style={{ width: w * 0.8, color: theme.blueColor,  fontSize: 15, justifyContent:'center'}}>{data.address}</Text>
                </View>
        ...
        return(
            <View style={{ minHeight: h, paddingBottom: 150}}>
                <Text style={{ fontSize: 30, color: theme.blueColor, marginLeft: 20, marginTop: 25, marginBottom: 20}}>{locale['departments']}</Text>
                {data.map( item => {
                    return( 
        ...
        return(
            ...
            <ScrollView>
                ...
                <Text style={{  fontSize: 22, marginTop: w * 0.2 + 20, marginLeft: 20, color: theme.blueColor,}}>{locale['chairperson']}</Text>
                <View style={[styles.box, styles.centerContent, styles.shadow2, {backgroundColor: theme.blockColor}]}>
                    <Text style={{ fontSize: 20, color: theme.blueColor}}>{data.fio}</Text>
                </View>
                <View style={[styles.box, styles.centerContent, styles.shadow2, {flexDirection: 'row', backgroundColor: theme.blockColor}]}>
                    <View style={{ width: w * 0.1, justifyContent: 'center', alignItems: 'center'}}>
                        <MaterialCommunityIcons name="map-marker" size={24} color="rgb(115, 182, 28)" />
