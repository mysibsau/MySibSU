...
import {View, Text, StyleSheet, AsyncStorage, Appearance } from 'react-native'
import Header from '../../modules/Header'
import { w } from '../../modules/constants'
import LangElem from '../../modules/Profile/LangElem'
    ...
    return(
        <View style={{ flex: 1, backgroundColor: theme.primaryBackground}}>
            ...
            <View style={{ flex: 1, backgroundColor: theme.primaryBackground}}>
                ...
                <Text style={{fontFamily: 'System', alignSelf: 'center', color: 'gray', position: 'absolute', bottom: 60}}>{locale['version']}: 2.0.0</Text>
