                ...
                <View>
                    ...
                    <View style={{ width: w * 0.8, borderRadius: 15, elevation: 6, backgroundColor: theme.blockColor, alignSelf: 'center', marginTop: 40 }}>
                        <View style={{ flexDirection: 'row', }}>
                            ...
                            <TextInput value={login} onChangeText={value => setUsername(value)} placeholderTextColor={'gray'} placeholder={locale['login']} numberOfLines={1} style={{ width: w * 0.7,  color: theme.labelColor }} />
                        </View>
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <TextInput onSubmitEditing={() => toAuth()} value={password} onChangeText={value => setPassword(value)} placeholderTextColor={'gray'} placeholder={locale['password']} numberOfLines={1} secureTextEntry={true} style={{ width: w * 0.7,  color: theme.labelColor }} />
                        </View>
                    </View>
                    ...
                    <TouchableOpacity onPress={() => checkAgreement() && signIn()}>
                        <Text style={{ alignSelf: 'center',  marginTop: 20, color: 'gray' }}>{locale['sign_in_as_guest']}</Text>
                    </TouchableOpacity>
                </View>
