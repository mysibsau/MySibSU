                ...
                {data.subgroups.map(item => {
                    return(
                        <View key={item.teacher + item.place}>
                            ...
                            {timetableMode !== 1 && <Text style={styles.professor}>{item.teacher}</Text>}
                            {timetableMode !== 0 && <Text style={[styles.professor, timetableMode !== 1 && {marginBottom: 3, marginTop: 3}]}>{item.group}</Text>}
                            {timetableMode !== 2 && <Text style={styles.place}>{item.place}</Text>}
                        </View>
                    )
                })} 
            </View>: 
