                ...
                <View> 
                        ...
                        <View>
                            ...
                            linkText={ url => regExpHelper.setLink(url)}>
                                <Text numberOfLines={3} style={{width: w * 0.85, color: theme.labelColor, padding: 5, alignSelf: 'center',  fontSize: 16}}>{regExpHelper.text}</Text>
                            </Hyperlink>
                        ...
                        <View>
                            ...
                            linkText={url => regExpHelper.setLink(url)}
                            >
                                <Text style={{width: w * 0.85, padding: 5, alignSelf: 'center',  fontSize: 16, color: theme.labelColor}}>{regExpHelper.text}</Text>
                            </Hyperlink>
